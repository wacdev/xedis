...
export class Xedis {
  ...
  xnext(group: Bin, consumer: Bin, count: bigint | undefined | null, block: bigint | undefined | null, noack: boolean, key: Bin): Promise<Array<Array<[Val, Array<[Val, Array<Val>]>]>>>
